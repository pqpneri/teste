...
(()=>{
  ...
  function canvas(d){
    ...
    const total=c.createLinearGradient(42,y,578,y+74);total.addColorStop(0,'#081b42');total.addColorStop(.58,'#173f91');total.addColorStop(1,'#6548da');rr(c,42,y,536,74,18,total);
...
(()=>{
  ...
  function remove(id){if(!confirm('Excluir este relatório de cliente?'))return;localStorage.setItem(key,JSON.stringify(get().filter(r=>r.id!==id)));render()}
  function render(){
